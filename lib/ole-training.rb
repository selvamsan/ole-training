...
module OleTraining
  ...
  Dir['lib/ole_training/*.rb'].sort.each {|file| require file}
  Dir['lib/ole_training/base_objects/**/*.rb'].sort.each {|file| require file}
  Dir['lib/ole_training/page_objects/**/*.rb'].sort.each {|file| require file}
  Dir['lib/ole_training/data_objects/**/*.rb'].sort.each {|file| require file}
  ...
  class << self
    ...
    def start_browser
      ...
      raise OleTraining::Error,"Browser connection not made after 5 minutes." unless browser.is_a?(Watir::Browser)
      browser
    end
